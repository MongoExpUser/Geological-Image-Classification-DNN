...
#  which can of practical in a variety of industrial and mineral extractive applications, including:
...
# 3) Save this file (geological_image_classification.py) in the CWD.
# 4) At the prompt, simply run: python geological_image_classification.py.
# *******************************************************************************************************************************************
# *******************************************************************************************************************************************
